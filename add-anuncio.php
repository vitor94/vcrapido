...
if(isset($_POST['titulo']) && !empty($_POST['titulo'])){
    ...
    $a->addAnuncio($titulo, $categoria, $telefone, $descricao, $fotos);
        ...
        <div class="row justify-content-center d-flex mt-5">
            ...
            <div class="col-lg-8 post-list">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-10">
                        <input type="text" name="titulo" placeholder="Titulo" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Primary color'"  class="single-input-primary">
                    </div>
                    <div class="mt-10">
                        <input type="text" name="telefone" placeholder="Telefone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Primary color'"  class="single-input-primary">
                    </div>
                    <div class="mt-10">
                        <textarea name="descricao" placeholder="Descrição" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Primary color'"  class="single-input-primary"></textarea>
                    </div>
                    <div class="mt-10 file">
                        <input type="file" name="fotos[]" placeholder="Telefone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Primary color'"  class="inputfile">
                        <div class="panel panel-default mt-3">
                            <div class=" col-7 card-header">Foto do Anuncio</div>
                            <div class="panel-body">
                            </div>
                        </div>
                    </div>

                    <button type="submit" class="genric-btn primary e-large mt-10">Adicionar</button>
                </form>
